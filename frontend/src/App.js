...
export class LoginPage extends React.Component {
  ...
  Login = () => {
    ...
    fetch(`http://${hostname}:4000/api/verifylogin?name=${username}&password=${password}`)
  ...
  Signup = () => {
    ...
    fetch(`http://${hostname}:4000/api/adduser?name=${username}&password=${password}`)
    .then(response => response.json())
    .then((data)=>{
